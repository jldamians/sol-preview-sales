...
function _getFormattedOutputData() {
  return this.data.filter((cpe) => {
    ...
    information.accountingPeriod = _changeDateFormat(this.period, DATE_FORMATS.accountingIso, DATE_FORMATS.accountingSunat)
 ...
 */
function _changeDateFormat(date, init = DATE_FORMATS.sunat, end = DATE_FORMATS.iso) {
